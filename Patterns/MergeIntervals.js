...
var merge = function(intervals) { // O(logN) and O(N)
...
var insert = function(intervals, newInterval) {// O(N) and O(N)
    /*
...
var employeeFreeTime = function(schedule) {// O(NlogN) and O(1)  
    /*
